...
const Register: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    // 닉네임 길이 검증
    if (
      formData.nexusNickname.length < 2 ||
      formData.nexusNickname.length > 20
    ) {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:focus:border-indigo-400 transition-colors"
